...
def callback_laser(msg):
    ...
    regions_ = { 
      ...
      'east': min(min(msg.ranges[30:34]), MAX_LIDAR_RANGE), 
...
def take_action():
    ...
    if regions['n-w'] < max_dist2robot and regions['n-e'] > max_dist2robot:
	change_state(3)
    elif regions['n-w'] > max_dist2robot and regions['n-e'] < max_dist2robot:
	change_state(1)
